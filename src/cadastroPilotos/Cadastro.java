...
import cadastroPilotos.piloto.Experiencia;
import cadastroPilotos.piloto.Titulacao;
...
public class Cadastro extends javax.swing.JInternalFrame {
    ...
    private Experiencia expProfissional;
    ...
    private void sButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sButtonActionPerformed
        ...
        if (Persistencia.checkDataTit(ano)) {
            ...
            if (((anoConc.getText().equals(""))) || ((nomeInt.getText().equals("")))
                ...
                titulacao = new Titulacao(Integer.parseInt(ano), nomeInstituicao, cidadePiloto, ufPiloto); //tratar excecao
    ...
    private void tButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tButtonActionPerformed
        ...
        if (((dInicio.getText().equals("  /  /    ")))
            ...
            expProfissional = new Experiencia(data, dataT, descricaoAtividade, empresaExperiencia,
    ...
    private void qButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_qButtonActionPerformed
        ...
        if (((modelo.getText().equals(""))) || ((jSpinner1.getValue().equals("0")))
            ...
            tipoAeronave = new Aeronave(modeloAeronave, Integer.parseInt(passageiros),
