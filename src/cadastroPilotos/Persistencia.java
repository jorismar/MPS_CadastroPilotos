...
//            outputPiloto = new DataOutputStream(new FileOutputStream("Piloto.dat", false));
//            outputTitulacao = new DataOutputStream(new FileOutputStream("Titulacao.dat", false));
//            outputExperiencia = new DataOutputStream(new FileOutputStream("Experiencia.dat", false));
//            outputTipo = new DataOutputStream(new FileOutputStream("Aeronave.dat", false));
//        } catch (IOException e) {
...
//    }
    ...
    public static void addRecords() {
        ...
        try {
            ...
            for (Piloto p : cadPiloto) {
                ...
                LinkedList<Experiencia> cadExpProfissional = p.getExpProfissional();
                outputExperiencia.writeInt(cadExpProfissional.size());
                for (Experiencia exp : cadExpProfissional) {
                ...
                LinkedList<Aeronave> cadTipoAeronave = p.getTipoAeronave();
    ...
    public static void readRecords() {
        ...
        LinkedList<Experiencia> expProf;
        LinkedList<Aeronave> tipAero;
        int i, anoConc;
        ...
        try {
            ...
            while (moreRecords){
                ...
                expProf = new LinkedList<Experiencia>();
                ...
                for (i = 0; i < qtde_exp; i++) {
                    ...
                    expProf.add(new Experiencia(dataI, dataT, descricaoA, empresa, nCidade, estado));
                }
                tipAero = new LinkedList<Aeronave>();
                ...
                for (i = 0; i < qtde_tip; i++) {
                    ...
                    tipAero.add(new Aeronave(modelo, capacidadePassageiros, horasDeVoo));
                }
